...
/*******************************************PRELOAD*******************************************/
var preload = {};
preload.overlay = document.getElementById("preload-overlay");
preload.timer = Date.now();
preload.minTime = 1000;
preload.hide = function(){
  t = setTimeout(function(){
    if (Date.now() - preload.timer < preload.minTime) {
      preload.hide();
    } else {
      preload.overlay.style.display = "none";
    }
  },100);
};
